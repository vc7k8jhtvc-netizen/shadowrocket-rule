...
advertising_mitm_check="$root/scripts/check-advertising-mitm-module.js"
...
[[ -f "$advertising_mitm_check" ]] || fail "missing Advertising MITM module checker"
...
node --check "$advertising_mitm_check"
