...
const expectedGroups = ['👆 手动选择','🇭🇰 香港','🏝️ 台湾','🇸🇬 新加坡','🇯🇵 日本','🇺🇸 美国','🤖 AI','🍎 Apple','🔎 Google','💻 GitHub','🪟 Microsoft','📱 社交媒体','▶️ YouTube','✈️ Telegram','🌍 Global','🛑 广告拦截','🚀 默认代理'];
...
const expectedDefaults = {'🤖 AI':'🇸🇬 新加坡','🍎 Apple':'DIRECT','🔎 Google':'🚀 默认代理','💻 GitHub':'🚀 默认代理','🪟 Microsoft':'DIRECT','📱 社交媒体':'🚀 默认代理','▶️ YouTube':'🚀 默认代理','✈️ Telegram':'🚀 默认代理','🌍 Global':'🚀 默认代理','🛑 广告拦截':'REJECT','🚀 默认代理':'🇭🇰 香港'};
...
assert(rules[rules.length - 1] === 'FINAL,🌍 Global', 'FINAL must route directly to Global and remain the last rule');
