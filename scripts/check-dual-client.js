...
for (const rule of ['DOMAIN-SUFFIX,deepseek.com,DIRECT','DOMAIN-SUFFIX,bytedance.com,DIRECT','DOMAIN-SUFFIX,bytedance.net,DIRECT']) { assert(shadowRules.includes(rule), 'Shadowrocket missing direct rule: ' + rule); assert(clash.rules.includes(rule), 'Clash missing direct rule: ' + rule); }
