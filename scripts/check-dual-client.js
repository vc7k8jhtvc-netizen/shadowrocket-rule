...
const canonicalShadow = ['Advertising/Advertising.list','Advertising/Advertising_Domain.list','Apple.list','Apple_Domain.list','Microsoft.list','GitHub.list','Telegram.list','bytedance.com','Twitter.list','Instagram.list','TikTok.list','YouTube.list','Google.list','/China/China.list','China_Domain.list','GEOIP,CN,DIRECT','FINAL,🌍 国际兜底'];
